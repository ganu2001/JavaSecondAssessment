...
INSERT INTO `category` VALUES (152,'Watch','Different Watches'),(153,'Shoes','Different Shoes');
...
INSERT INTO `category_seq` VALUES (251);
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`category_cid`) REFERENCES `category` (`cid`)
...
INSERT INTO `product` VALUES (403,'Normal_Watch',1200,'This is a Normal_Watch.',NULL),(404,'Smart_Watch',1200,'This is a Smart_Watch.',NULL),(405,'Sports_Watch',1200,'This is a Sports_Watch.',NULL);
...
-- Dump completed on 2024-03-04 17:55:21
